...
public record SendOptions
{
  ...
  [Category("Zeit")]
  [Description("Datum des Tages in einer Woche im Format dd.MM.yyyy")]
  [JsonProperty("nextWeek")]
  public string NextWeek { get; set; } = DateTime.Now.AddDays(7).ToString("dd.MM.yyyy");

  [Category("Zeit")]
  [Description("Datum des Tages vor einer Woche im Format dd.MM.yyyy")]
  ...
  [Category("Allgemein")]
  [Description("Basis-URL der Anwendung")]
  ...
  [Category("Allgemein")]
  [Description("Bezeichnung für die Umgebung")]
  ...
  [Category("Allgemein")]
  [Description("Standard-E-Mail-Adresse")]
  public string DefaultEmail { get; set; } = "cyber-lounge@co-IT.eu";

  [Category("Allgemein")]
  [Description("No-Reply-E-Mail-Adresse")]
